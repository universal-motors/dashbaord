                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li className='!mt-[38px] '>
                            <a href="#" className="flex items-center  text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap text-[#605BFF]">Upload</span>
                            </a>
                        </li>
                        <li className='!mt-[38px] pl-[31px]'>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li className='!mt-[38px] pl-[31px]'>
                            <a href="#" className="flex items-center p-2 text-[#9A9AA9] rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
